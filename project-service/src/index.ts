...
async function bootstrap() {
  ...
  app.get('/', (_req, res) => {
    res.json({
      ...
      graphql: {
        queries:   ['project', 'projects', 'myProjects', 'application', 'projectApplications', 'myApplications', 'submission'],
        mutations: ['createProject', 'updateProject', 'cancelProject', 'applyToProject', 'withdrawApplication', 'selectStudent', 'submitWork', 'reviewSubmission'],
      },
    });
  });
